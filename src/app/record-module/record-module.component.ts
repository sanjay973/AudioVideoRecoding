...
const adapter=require('webrtc-adapter/out/adapter_no_global.js')
...
@Component({  
  selector: 'app-record-module',
  templateUrl: './record-module.component.html',
  styleUrls: ['./record-module.component.css']
})
export class RecordModuleComponent implements OnInit, OnDestroy {
